 ...
 package com.renren.net.webserver
 {
 	...
 	public class ProtocalAdapter extends EventDispatcher
 	{
		...
		public function recordCurrPeerUserIDs(webServiceUrl:String, peerID:String, userID:String,isAdd:Boolean):void
		{
			if (webServiceUrl.length == 0 || peerID.length == 0 || userID.length == 0 )
			{
			...
			var request:Object = new Object();
			request.peerID=peerID; //服务端 map 的value
